...
namespace AssetStudio
{
    ...
    public class ACLClip
    {
        ...
        public bool IsSet => m_ClipData != null && m_ClipData.Length > 0;

        public void Process(out float[] values, out float[] times)
        {
            ACL.DecompressAll(m_ClipData, out values, out times);
        }
    }
}
